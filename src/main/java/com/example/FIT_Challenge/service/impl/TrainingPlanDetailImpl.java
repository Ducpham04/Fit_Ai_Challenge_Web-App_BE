...
import com.example.FIT_Challenge.DTO.TrainingPlanDetailDTO.TrainingPlanDetailResponse;
...
import com.example.FIT_Challenge.repository.TrainingPlanDetailRepository;
...
public class TrainingPlanDetailImpl implements TrainingPlanDetailService {
    ...
    private TrainingPlanDetailResponse toResponse(TrainingPlanDetail detail) {
        ...
        dto.setChallengeId(detail.getChallenge().getId());
